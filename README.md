...
* مدیریت و ساخت برنامه ورزشی :  (python-gui-tkinter-sqlite3-tksheet
(https://github.com/arvinashoori/sport-managment-app))

* سرویس  کراد با استفاده از رست فریمورک : (rest-django-crud-mysql
(https://github.com/arvinashoori/drf-project ))
