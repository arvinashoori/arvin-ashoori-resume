...
آروین عشوری متولد ۱۳۸۱  
میزان تحصیلات : کارشناسی مهندسی کامپیوتر آزاد کرج
سابقه کاری : به مدت ۳ سال سابقه در کد زدن در محیط کاری پایتون و انجام پروژه های شخصی 
---

### 🚀 درباره من:

علاقه مند به حوزه کاری (Backend Development)و توسعه وب .
متخصص در حوزه برنامه پایتون و همچنین فریم وورک جنگو.
علاقع مند هستم به ارايه راه حل های نوین و کاربردی در جهت حل چالش ها و مسايل حوزه کاری در خصوص اپلیکیشن های توسعه وب .
...
### 🛠️ مهارت ها  :
دارای مهارت های قابل قبول در(Backend Development) & (Django rest) & (Djago framework)
مشغول به اپدیت  شدن در حوزه های (MySQL)&(PostgreSQL)
